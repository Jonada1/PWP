    ...
    public class GetLimpingTestResponse: HALResponse
    {
        public GetLimpingTestResponse(LimpingTest test, Link selfLink = null) : base(new LimpingTestDto(test))
        {
            ...
            this.AddLinks(
                ...
                new LinkExtended("create", $"{ControllerUrls.LimpingTests}Create", "Create limping test", LinkMethods.POST, nameof(CreateLimpingTestDto)),
                ...
                new Link("getAnalysis", $"{ControllerUrls.Analysis}GetById/{test.TestAnalysisId}"),
